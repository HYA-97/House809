...
<DIV id=header class=wrap>
    <DIV id=logo><a href="javascript:location.href='/con5/Uhouse'"><IMG src="../images/logo.gif"></a></DIV></DIV>
<DIV id=regLogin class=wrap>
    <DIV class=dialog>
        ...
        <DIV class=box>
            <FORM id=add_action method=post enctype="multipart/form-data" action="/con5/addHouse">

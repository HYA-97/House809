...
<head>
    ...
    <script language="JavaScript">
        ...
        function Street2() {
            $('#dsDialog').window('setTitle',"添加区域");
            $('#dsDialog').window('open');
        ...
        function updateDialog(){
            ...
            if(SelectRows.length==1){
                ...
                //发异步请求查询数据库
                $.post("/con2/getOneStreet",{"id":SelectRows[0].id},function(data){
...
<div id="AddDialog" class="easyui-dialog" buttons="#AddDialogButtons"
    ...
    <form method="post" action="/con2/addDistrict" id="form1" name="form1">
...
<div id="updateDialog" class="easyui-dialog" buttons="#updateDialogButtons"
    ...
    <form method="post" action="/con1/update" id="form2" name="form2">
        ...
        街道名称:<input type="text" name="name" id="name3">
    </form>
</div>
<!--添加对话框的按钮-->

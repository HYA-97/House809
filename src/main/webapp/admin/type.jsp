    ...
    <script language="JavaScript">
        ...
        function updateDialog(){
            ...
            if(SelectRows.length==1){
                ...
                //发异步请求查询数据库
                $.post("/con3/getOneType",{"id":SelectRows[0].id},function(data){
        ...
        function delOne() {
            ...
            $.post("/con3/delOne",{"id":id},function (i) {
                if(i==1){
                    $('#dg').datagrid("reload");
        ...
        function delBatch() {
            ...
            if(SelectRows.length==0){
                ...
                if(ids.length>0){
                    $.post("/con3/delBatch", {"ids":ids.toString()}, function (i) {
...
<div id="AddDialog" class="easyui-dialog" buttons="#AddDialogButtons"
    ...
    <form method="post" action="/con3/addType" id="form1" name="form1">
...
<div id="updateDialog" class="easyui-dialog" buttons="#updateDialogButtons"
     style="width: 280px; height: 250px; padding: 10px 20px;" closed="true">
    <form method="post" action="/con3/update" id="form2" name="form2">

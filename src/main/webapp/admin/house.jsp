...
<head>
    ...
    <script language="JavaScript">
            ...
            $('#dg').datagrid({
                ...
                columns:[[
                    ...
                    {field:'p',title:'审核',width:100,
                        formatter: function(value,row,index){
                            var str="<a href='javascript:pass()'>审核</a>"
                            return str;
                        }
                    }
                ]]
        ...
        /*function pass() {
            ...
            location.href="/con5/update?isPass=1$id="+id;
            $('#dg').datagrid("reload");
        }*/
        ...
        function pass() {
            var SelectRows = $("#dg").datagrid('getSelections');
            var id = SelectRows[0].id;
            $.post("/con5/update?ispass=1",{"id":id},function (i) {
                if(i==1){
                    $('#dg').datagrid("reload");
        ...
        function updateDialog(){
            ...
            if(SelectRows.length==1){
                ...
                //发异步请求查询数据库
                $.post("/con5/getOneHouse",{"id":SelectRows[0].id},function(data){
